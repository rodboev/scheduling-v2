    ...
    geometry: {
      ...
      coordinates: [
        [
          ...
          [-73.9451, 40.7829], // Central Park East - ADJUSTED
          [-73.9432, 40.7789], // Upper East Side - ADDED
          [-73.9421, 40.7745], // Upper East Side South - ADDED
          [-73.9532, 40.7589], // Midtown East
          [-73.9558, 40.7453], // Murray Hill
          [-73.9549, 40.7366], // Kips Bay
          [-73.9524, 40.7272], // Stuyvesant Town
          [-73.9584, 40.7219], // East Village
          [-73.9667, 40.7123], // Lower East Side
          [-73.9754, 40.7046], // Two Bridges
          [-73.9846, 40.7046], // Financial District East
